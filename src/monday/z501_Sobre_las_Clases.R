...
# Poner sus semillas
semillas <- c(177, 197, 273, 297, 317)
...
modelo_bin2 <- rpart(clase_binaria2 ~ . - clase_ternaria - clase_binaria1, #Ponemos menos asi no entran las otras variables 
                data = dtrain,
                xval = 0,
                control = parametros)
...
#Acá al mixear clases tocamos las proporciones, grave
#Esto nos afecta el punto de corte (que tenemos fijo en 0.025 desde la 1ra clase)
...
## Preguntas
## ¿Sigue siendo el punto de corte optimo 0.025? "Debería elegir el 0.07"??
...
#Mejor valor en test: 23 millones. Es distinto al de train (24?)
...
#Las tablas muestran la posición de la p con mejor ganancia para train y test
#Si la p coincide mostrará solo 1 fila, sino, las dos posiciones y las filas intermedias entre ellas
#n: cantidad de registros por hoja?
#p: probabilidad de pertenencia a una clase?
#gan: ganancia 
...
#Punto de corte mas alto para ser mas conservadores?
#¿Optimizar el punto de corte para que sea un parametro mas? Se podria trabajar por OB
#No hace falta que sea un rango enorme
