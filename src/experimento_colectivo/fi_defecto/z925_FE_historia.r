...
PARAM  <- list()
PARAM$experimento <- "FE9250_ec_fi"
...
CanaritosAsesinos  <- function( canaritos_ratio)
{
  ...
  dataset[ , entrenamiento := foto_mes>= 202012 &  foto_mes<= 202102  & ( clase01==1 | azar < 0.10 ) ]
  ...
  fwrite( tb_importancia, 
          file= paste0( "impo_", GVEZ ,"_ratio_", canaritos_ratio ,".txt"),
          sep= "\t" )
