...
PARAM  <- list()
PARAM$experimento <- "TS9310_sh_ratio1"

PARAM$exp_input  <- "FE9250_sh_ratio1"
...
dataset_input  <- paste0( "./exp/", PARAM$exp_input, "/dataset_ratio_1.csv.gz" )
