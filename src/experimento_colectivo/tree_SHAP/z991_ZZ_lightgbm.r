...
PARAM$exp_input  <- "HT9410_sh_ratio1"
PARAM$corte = 9000
...
arch_dataset  <- paste0( base_dir, "exp/", TS, "/dataset_train_final_ratio_1.csv.gz" )
dataset  <- fread( arch_dataset )

#leo el dataset donde voy a aplicar el modelo final
arch_future  <- paste0( base_dir, "exp/", TS, "/dataset_future_ratio_1.csv.gz" )
...
for (j in vector_semillas)
{
  ...
  for( i in  1:PARAM$modelos )
  {
    ...
    #ganancia_promedio_modelo <- mean(ganancia_iter)
