...
setwd("C:/Users/PC/Documents/DMEyF")  #Establezco el Working Directory
...
dapply[, r_ctrx_quarter := ntile(ctrx_quarter, 10)]
...
for( corte  in  c( 7500, 8000, 8500, 9000, 9500, 10000, 10500, 11000 ) )
{
  ...
  fwrite( dfinal[ , list(numero_de_cliente, Predicted) ], #solo los campos para Kaggle
          file= paste0( "./exp/KA4120/KA4120_005_FE2_",  corte, ".csv"),
          sep=  "," )
}
